    ...
    <div className={`nc-SectionPromo1 relative flex flex-col lg:flex-row items-center ${className}`}>
      <div className="relative flex-shrink-0 mb-16 lg:mb-0 lg:mr-10 lg:w-2/5">
        ...
        <h2 className="font-semibold text-3xl sm:text-4xl xl:text-5xl 2xl:text-6xl mt-6 sm:mt-10 !leading-[1.2] tracking-tight">
          Save money <br /> with Sulfur8®
        </h2>
        <span className="block mt-6 text-slate-500 dark:text-slate-400 ">With Sulfur8® you will get more for less</span>
        <div className="flex space-x-2 sm:space-x-5 mt-6 sm:mt-12">
          <ButtonPrimary href="/products" className="">
            Buy Wholesale
          </ButtonPrimary>
          <ButtonSecondary href="/products" className="border border-slate-100 dark:border-slate-700">
            Buy Retail
          </ButtonSecondary>
        </div>
      </div>
